...
<title>睦拍-登录</title> 
<meta name="keywords" content="睦拍-应用内支付平台后台管理系统" />
<meta name="description" content="睦拍-应用内支付平台后台管理系统" />
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
               ...
               <div class="inputOuter" id="pArea">
                ...
                <div class="pwdArea" id="pwdArea">
                <input type="radio" name="role">开发者</input>
                <input type="radio" name="role">渠道</input>
                </div>
...
<div class="jianyi">推荐使用ie8或以上版本ie浏览器</div>
</body></html>